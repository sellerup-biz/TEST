"""
PROCARE — сбор ежедневных данных за текущий месяц (разовый запуск, мульти-магазин)
...
print(f"{'='*55}")
print(f"  {CONFIG['project']} — ежедневный сбор за текущий месяц")
...
# Собираем данные: один комбинированный record на каждый день
for date_str in dates_to_collect:
    ...
    for shop_name, shop in SHOPS.items():
        ...
        print(f"    {shop_name}: PLN={total:,.2f}  costs={tc:,.2f}")
